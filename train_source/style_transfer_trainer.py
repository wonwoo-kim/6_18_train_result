...
class StyleTransferTrainer:
    ...
    def train(self):
        ...
        tf.train.write_graph(self.sess.graph_def, '.', './output/linear_regression.pb', as_text=False)
        tf.train.write_graph(self.sess.graph_def, '.', './output/linear_regression.pbtxt', as_text=True)
